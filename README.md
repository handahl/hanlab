...
1. **Verify Volume Labels**: Ensure mount points use :Z (private) or :z (shared) relabeling options in the .container file. Or get into udica and make your own rules (better).
2. **Inspect Denials**:  
